...
<button class="toggle-menu-button" id="toggle-menu-button" onclick="toggleMenu()">
 ...
 <div class="nav-right">
  ...
  <div class="contenedor">
        ...
        <div class="hilera">
            <h2>1er año</h2>
            <button class="boton">Lengua Extranjera: Inglés Técnico I</button>
            <button class="boton">Informática</button>
            <button class="boton">Inclusión Educativa</button>
            <button class="boton">Matemática</button>
            <button class="boton">Electrónica</button>
            <button class="boton">Sistemas de Representación Gráfica</button>
            <button class="boton">Física</button>
            <button class="boton">Práctica Profesionalizante I: Mecánica de la Robótica</button>
            
           
        </div>
        <div class="hilera">
            <h2>2do Año</h2>
            <button class="boton">Lengua Extranjera: Inglés Técnico II</button>
            <button class="boton">Seguridad e Higiene</button>
            <button class="boton">Programación</button>
            <button class="boton">Álgebra</button>
            <button class="boton">Equipos y Aparatos Eléctricos</button>
            <button class="boton">Microcontroladores</button>
            <button class="boton">Práctica Profesionalizante II: Control de Motores Eléctricos y Laboratorio de PLC'S</button>
            <button class="boton">Seminario: Laboratorio de Microcontroladores</button>
            
        </div>
        <div class="hilera">
            <h2>3er año</h2>
            <button class="boton">Legislación y Ejercicio Profesional</button>
            <button class="boton">Sistemas de Control</button>
            <button class="boton">Automatismo</button>
            <button class="boton">Robótica</button>
            <button class="boton">Seminario: Laboratorio de Simulación</button>
            <button class="boton">Práctica Profesionalizante III: Proyecto Final y Pasantía</button>
