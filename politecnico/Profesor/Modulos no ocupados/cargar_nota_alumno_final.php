...
<button id="open-attendance-button" onclick="openAttendanceModalverasistencia()">Ver notas generales </button>
...
<button id="open-attendance-button" onclick="openAttendanceModal()">Abrir Tabla de Notas de alumnos</button>
  ...
  <h2>Elige la carrera Deseada : </h2>
 
  <button class="comission-button" onclick="openModalComisionA()">  Automatizacion y Robotica </button>
  <button class="comission-button" onclick="openModalComisionB()"> Acompañamiento Terapeutico</button>
  <button class="comission-button" onclick="openModalComisionC()">Comercializacion y Marketing</button>
  <button class="comission-button" onclick="openModalComisionC()"> Enfermeria</button>
  
  </div>
    </div>
        
<!-- Modal de  Auromatizacion y Robotica -->
<div id="asistenciamodalComisionA" class="modal-comision-a">
    ...
    <h1>Auromatizacion y Robotica</h1> 
        <div class="table-responsive">
    ...
    where ia.carreras_idCarrera = '46' or 
        ia.carreras_idCarrera = '47' or 
        ia.carreras_idCarrera = '48' or 
        ia.carreras_idCarrera = '49' or 
        ia.carreras_idCarrera = '50' or 
        ia.carreras_idCarrera = '51' or
        ia.carreras_idCarrera = '52' or 
        ia.carreras_idCarrera = '53' or 
        ia.carreras_idCarrera = '54';
    -- hay un monton de variables como diferenciamos de los alumnos de 1 año a los de segundo año , 
    -- la diferencia de carrera es facil por que se distinguen cuando se inscriben los alumnos 
        -- sustema funcional solo para tecnicaturas no FP";
    $query = mysqli_query($conexion, $sql);
...
<!-- Modal de Acompañamiento Terapeutico -->
<div id="asistenciamodalComisionB" class="modal-comision-b">
    ...
    <h1>Acompañamiento Terapeutico</h1> 
        <div class="table-responsive">
      
                <table class="table-comision-a" id="tabla2" >
                        <thead>
    ...
    inner join condicion_materia cm on f.condicion_materia_idcondicion_materia = cm.idcondicion_materia 
    inner join inscripcion_asignatura ia on ia.alumno_legajo = a.legajo 
    where ia.carreras_idCarrera = '27' or 
        ia.carreras_idCarrera = '31' or 
        ia.carreras_idCarrera = '32' or 
        ia.carreras_idCarrera = '40' or 
        ia.carreras_idCarrera = '41' or 
        ia.carreras_idCarrera = '42' or
        ia.carreras_idCarrera = '43' or 
        ia.carreras_idCarrera = '44' or 
        ia.carreras_idCarrera = '45';
    -- hay un monton de variables como diferenciamos de los alumnos de 1 año a los de segundo año , 
    -- la diferencia de carrera es facil por que se distinguen cuando se inscriben los alumnos 
        -- sustema funcional solo para tecnicaturas no FP";
    $query = mysqli_query($conexion, $sql);
...
<!-- Modal de Comercializacion y Marketing  -->
<div id="asistenciamodalComisionC" class="modal-comision-c">
    ...
    <h1> Comercializacion y Marketing </h1> 
        <div class="table-responsive">
      
                <table class="table-comision-a" id="tabla3" >
                        <thead>
    ...
    inner join condicion_materia cm on f.condicion_materia_idcondicion_materia = cm.idcondicion_materia 
    inner join inscripcion_asignatura ia on ia.alumno_legajo = a.legajo 
    where ia.carreras_idCarrera = '55' or 
        ia.carreras_idCarrera = '56' or 
        ia.carreras_idCarrera = '57' or 
        ia.carreras_idCarrera = '58' or 
        ia.carreras_idCarrera = '59' or 
        ia.carreras_idCarrera = '60' or
        ia.carreras_idCarrera = '61' or 
        ia.carreras_idCarrera = '62' or 
        ia.carreras_idCarrera = '63';
    -- la diferencia de carrera es facil por que se distinguen cuando se inscriben los alumnos 
        -- sistema funcional solo para tecnicaturas no FP";
    $query = mysqli_query($conexion, $sql);
    while ($datos = mysqli_fetch_assoc($query)) {
        ?>
...
<div id="asistenciamodalComisionC" class="modal-comision-c">
    ...
    <h1> Enfermeria </h1> 
        <div class="table-responsive">
                ...
                <table class="table-comision-a" id="tabla4" >
                        <thead>
    ...
    inner join condicion_materia cm on f.condicion_materia_idcondicion_materia = cm.idcondicion_materia 
    inner join inscripcion_asignatura ia on ia.alumno_legajo = a.legajo 
    where ia.carreras_idCarrera = '18' or 
        ia.carreras_idCarrera = '19' or 
        ia.carreras_idCarrera = '20' or 
        ia.carreras_idCarrera = '33' or 
        ia.carreras_idCarrera = '34' or 
        ia.carreras_idCarrera = '35' or
        ia.carreras_idCarrera = '36' or 
        ia.carreras_idCarrera = '37' or 
        ia.carreras_idCarrera = '39';
    -- la diferencia de carrera es facil por que se distinguen cuando se inscriben los alumnos 
        -- sistema funcional solo para tecnicaturas no FP";
    $query = mysqli_query($conexion, $sql);
    while ($datos = mysqli_fetch_assoc($query)) {
